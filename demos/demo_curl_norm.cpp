...
{
    double t0 = elapsed();
const char* LEARN = "curl/curl_learn_norm.txt";
 const char* BASE="curl/curl_base_norm.txt";
const char* QUERY="curl/curl_query_norm.txt";
   const char* GT="curl/curl_gt_cos.txt";
 
   // this is typically the fastest one.
    // const char *index_key = "IVF4096,Flat";
   const char *index_key = "LSH512";
...
//  const char *index_key = "PQ500";
    faiss::Index * index;

    size_t dim=7500;
   size_t num = 7500;
    size_t d;
    size_t learn_num=750;
size_t q=1000;
double t1;
    {
