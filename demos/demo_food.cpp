...
size_t q=1000;
    {
        ...
        size_t nt;
        float *xt = fvecs_read("food/food_learn.txt", 2005 ,dim, &d, &nt);
...

    {
        ...
        size_t nb, d2;
        float *xb = fvecs_read("food/food_base.txt",num,dim, &d2, &nb);
...
float *xq;

    {
        ...
        size_t d2;
        xq = fvecs_read("food/food_query.txt",q,dim, &d2, &nq);
//	for(int i=0;i < 3000; i=i+1000){printf("%f , ",xq[i]);}
...

    {
        ...
        size_t nq2;
float *gt_int = fvecs_read("food/food_gt.txt",q,100, &k, &nq2);
