...
{
    double t0 = elapsed();
const char* LEARN = "generate_input/MBTI_tfidf_learn.txt";
 const char* BASE="generate_input/MBTI_tfidf_base.txt";
const char* QUERY="generate_input/MBTI_tfidf_query.txt";
   const char* GT="generate_input/MBTI_tfidf_gt.txt";
printf("index is %s",argv[1]); 
