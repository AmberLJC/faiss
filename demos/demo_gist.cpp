...
int main(int argc, char *argv[]) {
    ...
    char learn_filename[50] = "../../naive_PQ_sparse/gist/gist_learn.fvecs";
    char query_filename[50] = "../../naive_PQ_sparse/gist/gist_query.fvecs";
    char base_filename[50] = "../../naive_PQ_sparse/gist/gist_base.fvecs";
    ...
    size_t max_buff_size = int(nb/10);

    std::vector<float> buff;
    buff.resize(max_buff_size * dim);
    ItrReader reader(base_filename, "fvecs");
