...
size_t q=1000;
    {
        ...
        size_t nt;
        float *xt = fvecs_read("img_sift_learn_bal.txt",  10000 ,dim, &d, &nt);
...

    {
        ...
        size_t nb, d2;
        float *xb = fvecs_read("img_sift_base_bal.txt",num,dim, &d2, &nb);
...
float *xq;

    {
        ...
        size_t d2;
        xq = fvecs_read("img_sift_query_bal.txt",q,dim, &d2, &nq);
