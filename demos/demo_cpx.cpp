...
{double t1;
 ...
 //const char *index_key = "IMI2x8,PQ8+10";// this is typically the fastest one.
    // const char *index_key = "IVF4096,Flat";
     const char *index_key = "LSH400";
    // const char *index_key = "HNSW128_2x32";
   //  const char *index_key = "Flat";
  // const char *index_key = "HNSW24";
...
size_t q=1000;
    {
        ...
        size_t nt;
        float *xt = fvecs_read("complex/complex_learn.txt",  num/10 ,dim, &d, &nt);
...

    {
        ...
        size_t nb, d2;
        float *xb = fvecs_read("complex/complex_base.txt",num,dim, &d2, &nb);
 ...
 delete [] xb;
...

    {
        ...
        size_t d2;
        xq = fvecs_read("complex/complex_query.txt",q,dim, &d2, &nq);
//	for(int i=0;i < 3000; i=i+1000){printf("%f , ",xq[i]);}
...

    {
        ...
        size_t nq2;
float *gt_int = fvecs_read("complex/complex_gt.txt",q,100, &k, &nq2);
